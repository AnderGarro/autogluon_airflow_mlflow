...
from python_operators.stroke_functions import insert_data_batch
...
with DAG(dag_id='sc_insert_data', default_args=args, schedule_interval='0 * * * 1-5', catchup=False) as dag:
    insert_data_task = PythonOperator(task_id='insert_data_batch',
                                     provide_context=True,
                                     python_callable=insert_data_batch)
